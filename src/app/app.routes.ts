...
export const routes: Routes = [
 {
  ...
  data: {
    title: 'Lucentive — Clarity that Compounds',
    description: 'Lucentive simplifies systems so growth becomes inevitable—more inquiries, faster responses, clearer decisions. Every engagement is designed to pay for itself.'
  }
},
  { path: 'services', loadComponent: () => import('./pages/services/services.component').then(m => m.ServicesComponent),
    data: {
      title: 'Services that Drive Growth | Lucentive',
  ...
  { path: 'case-studies', loadComponent: () => import('./pages/case-studies/case-studies.component').then(m => m.CaseStudiesComponent),
    data: {
      title: 'Profit Stories & Results | Lucentive',
  ...
  { path: 'pricing', loadComponent: () => import('./pages/pricing/pricing.component').then(m => m.PricingComponent),
    data: {
      title: 'Clear Pricing & ROI-Focused Packages | Lucentive',
  ...
  { path: 'about', loadComponent: () => import('./pages/about/about.component').then(m => m.AboutComponent),
    data: {
      title: 'About Lucentive | We Focus on Your Bottom Line',
  ...
  { path: 'contact', loadComponent: () => import('./pages/contact/contact.component').then(m => m.ContactComponent),
    data: {
      title: 'Let\'s Find Your Growth Opportunity | Contact Lucentive',
